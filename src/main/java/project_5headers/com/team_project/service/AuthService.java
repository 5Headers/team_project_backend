...
import project_5headers.com.team_project.entity.*;
...
public class AuthService {
    ...
    public ApiRespDto<?> signup(SignupReqDto signupReqDto) {
        try {
            ...
            if (optionalUser.isEmpty()) throw new RuntimeException("회원정보 추가 실패");
            ...
            if (addUserRoleResult != 1) throw new RuntimeException("권한 추가 실패");
